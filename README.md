...
{ german: "Ich bin der gleichen Ansicht.", russian: "Я того же мнения." },
{ german: "Das sehe ich anders.", russian: "Я вижу это по-другому." },
{ german: "Kann ich mich hier setzen?", russian: "Могу я сесть здесь?" },
{ german: "Darf ich mal vorbei?", russian: "Можно пройти?" },
{ german: "Entschuldigung, das war nicht so gemeint.", russian: "Извините, я не это имел в виду." },
{ german: "Ich habe mich verspätet.", russian: "Я опоздал." },
{ german: "Kein Problem, dafür gibt es eine Lösung.", russian: "Без проблем, для этого есть решение." },
{ german: "Das ist eine gute Idee!", russian: "Это хорошая идея!" },
{ german: "Darüber habe ich noch nicht nachgedacht.", russian: "Я об этом ещё не думал." },
{ german: "Ich habe nächste Woche Prüfungen.", russian: "На следующей неделе у меня экзамены." },
{ german: "Ich suche einen Job als Kellner.", russian: "Я ищу работу официантом." },
{ german: "Könnten Sie mir das bitte erklären?", russian: "Не могли бы вы мне это объяснить?" },
{ german: "Das ist mir unangenehm.", russian: "Мне неловко." },
{ german: "Ich habe Heimweh.", russian: "Я скучаю по дому." },
{ german: "Das ist eine schwierige Entscheidung.", russian: "Это трудное решение." },
{ german: "Ich bin mir nicht sicher.", russian: "Я не уверен." },
{ german: "Lass uns einen Spaziergang machen.", russian: "Давай сходим на прогулку." },
{ german: "Das Wetter ist heute schön.", russian: "Погода сегодня красивая." },
{ german: "Ich mag Tiere, besonders Hunde.", russian: "Я люблю животных, особенно собак." },
{ german: "Hast du Geschwister?", russian: "У тебя есть братья или сёстры?" },
{ german: "Wie war dein Wochenende?", russian: "Как прошли твои выходные?" },
{ german: "Ich bin stolz auf dich.", russian: "Я горжусь тобой." },
{ german: "Das ist mir peinlich.", russian: "Мне стыдно." },
{ german: "Ich habe keine Zeit dafür.", russian: "У меня нет на это времени." },
{ german: "Kannst du mir das kurz erklären?", russian: "Можешь мне это кратко объяснить?" },
{ german: "Ich wünsche dir viel Glück!", russian: "Желаю тебе удачи!" },
{ german: "Lass uns in Kontakt bleiben.", russian: "Давай оставаться на связи." },
{ german: "Das ist eine tolle Leistung!", russian: "Это отличное достижение!" },
{ german: "Ich bin gerade beschäftigt.", russian: "Я сейчас занят." }
        ],
        ...
        C1: [
            ...
            // ========== СЛОЖНЫЕ СЛОВА (C1) ==========
{ german: "die Eigenverantwortung", russian: "личная ответственность" },
{ german: "die Leistungsgesellschaft", russian: "общество, ориентированное на достижения" },
{ german: "der Bedeutungswandel", russian: "изменение значения" },
{ german: "unvorhersehbar", russian: "непредсказуемый" },
{ german: "die Querschnittskompetenz", russian: "междисциплинарный навык" },
{ german: "handlungsorientiert", russian: "ориентированный на действие" },
{ german: "die Entscheidungsfindung", russian: "процесс принятия решений" },
{ german: "widerlegbar", russian: "опровержимый" },
{ german: "die Wissenschaftsdisziplin", russian: "научная дисциплина" },
{ german: "fachübergreifend", russian: "междисциплинарный" },

// ========== СЛОЖНЫЕ ФРАЗЫ И ДИСКУССИОННЫЕ КЛИШЕ ==========
{ german: "Vor diesem Hintergrund lässt sich argumentieren, dass...", russian: "На этом фоне можно утверждать, что..." },
{ german: "Diese These ist nicht haltbar, weil...", russian: "Этот тезис несостоятелен, потому что..." },
{ german: "Die empirische Evidenz deutet darauf hin, dass...", russian: "Эмпирические данные указывают на то, что..." },
{ german: "Man muss zwischen Ursache und Wirkung differenzieren.", russian: "Нужно различать причину и следствие." },
{ german: "Dieses Phänomen ist multikausal bedingt.", russian: "Это явление обусловлено множеством причин." },
{ german: "Die Implikationen dieser Entscheidung sind weitreichend.", russian: "Последствия этого решения далеко идущие." },

// ========== ДЛИННЫЕ ПРЕДЛОЖЕНИЯ / ТЕКСТЫ ДЛЯ АУДИРОВАНИЯ (озвучка) ==========
{ german: "In der heutigen globalisierten Welt ist es unerlässlich, über interkulturelle Kompetenzen zu verfügen, um erfolgreich zu kommunizieren.", russian: "В сегодняшнем глобализированном мире необходимо обладать межкультурными компетенциями для успешной коммуникации." },
{ german: "Die Digitalisierung hat nahezu alle Lebensbereiche durchdrungen und stellt uns vor völlig neue ethische Herausforderungen.", russian: "Цифровизация проникла практически во все сферы жизни и ставит перед нами совершенно новые этические вызовы." },
{ german: "Nachhaltigkeit bedeutet nicht nur Umweltschutz, sondern auch soziales Miteinander und wirtschaftliche Stabilität für zukünftige Generationen.", russian: "Устойчивость означает не только защиту окружающей среды, но и социальное взаимодействие и экономическую стабильность для будущих поколений." },
{ german: "Trotz aller Fortschritte in der Medizin bleiben viele Krankheiten nach wie vor unheilbar, was die Forschung weiterhin vor große Hürden stellt.", russian: "Несмотря на весь прогресс в медицине, многие болезни по-прежнему неизлечимы, что ставит исследования перед большими препятствиями." },
{ german: "Ein tiefgreifendes Verständnis von Mathematik ist eine grundlegende Voraussetzung für viele Studiengänge im MINT-Bereich.", russian: "Глубокое понимание математики является фундаментальным условием для многих учебных программ в области STEM." },
{ german: "Die Fähigkeit, kritisch zu denken und Informationen zu hinterfragen, gehört zu den wichtigsten Schlüsselkompetenzen des 21. Jahrhunderts.", russian: "Способность критически мыслить и подвергать информацию сомнению относится к важнейшим ключевым навыкам XXI века." },
{ german: "Angesichts des demografischen Wandels wird die Einwanderung von qualifizierten Fachkräften für viele Industrienationen überlebenswichtig.", russian: "Ввиду демографических изменений иммиграция квалифицированных специалистов становится жизненно важной для многих промышленно развитых стран." },
{ german: "Nicht zuletzt aufgrund des Klimawandels gewinnen erneuerbare Energien wie Solar- und Windkraft rasant an Bedeutung.", russian: "Не в последнюю очередь из-за изменения климата возобновляемые источники энергии, такие как солнечная и ветровая, быстро набирают значимость." },
            // ========== ДЛИННЫЕ ТЕКСТЫ ДЛЯ АУДИРОВАНИЯ (C1) ==========
{ german: "Der Klimawandel ist eine der größten Herausforderungen unserer Zeit. Die globale Durchschnittstemperatur steigt, Polkappen schmelzen, und extreme Wetterereignisse häufen sich. Wissenschaftler sind sich einig, dass der Mensch durch die Verbrennung fossiler Brennstoffe, Entwaldung und industrielle Landwirtschaft maßgeblich dazu beiträgt. Um die Erwärmung auf 1,5 Grad zu begrenzen, sind drastische Maßnahmen nötig: Ausbau erneuerbarer Energien, CO2-Bepreisung, nachhaltige Mobilität und Kreislaufwirtschaft. Doch politische Interessen und wirtschaftliche Abhängigkeiten bremsen den Wandel. Jeder Einzelne kann durch bewussten Konsum, Energiesparen und weniger Flugreisen einen Beitrag leisten. Letztlich geht es um die Frage: Wie wollen wir in Zukunft leben?", russian: "Изменение климата — одно из величайших вызовов нашего времени. Средняя глобальная температура растёт, полярные шапки тают, экстремальные погодные явления учащаются. Учёные сходятся во мнении, что человек вносит основной вклад через сжигание ископаемого топлива, вырубку лесов и промышленное сельское хозяйство. Чтобы ограничить потепление 1,5 градусами, необходимы drastic меры: расширение возобновляемой энергетики, углеродный налог, устойчивая мобильность и циркулярная экономика. Но политические интересы и экономические зависимости тормозят изменения. Каждый может внести вклад через осознанное потребление, экономию энергии и отказ от частых перелётов. В конечном счёте вопрос: как мы хотим жить в будущем?" },

{ german: "Die Zukunft der Arbeit wird durch Automatisierung, Künstliche Intelligenz und Digitalisierung radikal verändert. Viele traditionelle Berufe verschwinden, während neue entstehen – etwa im Bereich Data Science, Robotik oder grüne Technologien. Gleichzeitig wächst die Nachfrage nach sozialen und kreativen Kompetenzen, die Maschinen nicht ersetzen können. Die Corona-Pandemie hat beschleunigt, was ohnehin gekommen wäre: Homeoffice, digitale Teamarbeit und flexible Arbeitszeiten. Arbeitnehmer müssen lebenslang lernen, um Schritt zu halten. Unternehmen stehen vor der Herausforderung, ihre Belegschaft umzuschulen und eine gesunde Work-Life-Balance zu fördern. Auch das Konzept des Grundeinkommens wird diskutiert, um mit möglichen Arbeitsplatzverlusten umzugehen. Die Gesellschaft muss entscheiden, wie viel technologischen Fortschritt sie möchte und welche Arbeitsbedingungen sie als menschenwürdig erachtet.", russian: "Будущее работы кардинально меняется благодаря автоматизации, искусственному интеллекту и цифровизации. Многие традиционные профессии исчезают, в то время как возникают новые — например, в области науки о данных, робототехники или зелёных технологий. Одновременно растёт спрос на социальные и творческие навыки, которые машины не могут заменить. Пандемия коронавируса ускорила то, что в любом случае должно было произойти: удалённую работу, цифровое командное взаимодействие и гибкий график. Работники должны учиться всю жизнь, чтобы не отставать. Компании сталкиваются с задачей переквалификации персонала и поддержания здорового баланса между работой и личной жизнью. Также обсуждается концепция базового дохода для компенсации возможной потери рабочих мест. Общество должно решить, какой технологический прогресс оно хочет и какие условия труда считает достойными." },

{ german: "Künstliche Intelligenz durchdringt immer mehr Bereiche unseres Alltags – von Sprachassistenten über Gesichtserkennung bis hin zu medizinischen Diagnosen. Maschinelles Lernen ermöglicht es Computern, Muster zu erkennen und Entscheidungen zu treffen, die früher Menschen vorbehalten waren. Dies bringt enorme Chancen: effizientere Verwaltung, personalisierte Medizin, bessere Verkehrssteuerung. Gleichzeitig gibt es Risiken: algorithmische Vorurteile, Überwachung, Manipulation durch soziale Medien und den Verlust von Privatsphäre. Die Frage nach ethischen Richtlinien für KI wird immer drängender. Soll eine KI autonome Fahrzeuge entscheiden lassen, wen sie bei einem Unfall schützt? Dürfen Arbeitgeber Bewerber mit KI analysieren? Benötigen wir ein Recht auf Erklärung, wenn Algorithmen über unser Leben entscheiden? Die Europäische Union arbeitet an einem Rechtsrahmen für vertrauenswürdige KI. Letztlich geht es darum, dass Technologie dem Menschen dient und nicht umgekehrt.", russian: "Искусственный интеллект проникает во всё больше областей нашей повседневной жизни — от голосовых помощников до распознавания лиц и медицинской диагностики. Машинное обучение позволяет компьютерам распознавать паттерны и принимать решения, которые раньше были прерогативой человека. Это несёт огромные возможности: более эффективное управление, персонализированная медицина, лучшее управление трафиком. В то же время существуют риски: алгоритмические предубеждения, слежка, манипуляции через социальные сети и потеря приватности. Вопрос этических норм для ИИ становится всё более насущным. Должен ли ИИ в автономных автомобилях решать, кого защищать при аварии? Могут ли работодатели анализировать соискателей с помощью ИИ? Нужно ли нам право на объяснение, когда алгоритмы влияют на нашу жизнь? Европейский союз работает над правовой базой для надёжного ИИ. В конечном счёте, технология должна служить человеку, а не наоборот." },

{ german: "Reisen erweitert den Horizont und fördert Toleranz. Wer fremde Kulturen, Sprachen und Lebensweisen kennenlernt, entwickelt Verständnis für andere Perspektiven. Nachhaltiges Reisen bedeutet, lokale Wirtschaften zu unterstützen, Ressourcen zu schonen und Respekt vor der Natur zu zeigen. Statt Massentourismus empfehlen sich Langzeitaufenthalte oder Öko-Lodges. Zugreisen emittieren weniger CO2 als Flüge, und Fahrradreisen sind am klimafreundlichsten. Leider führt Overtourism an beliebten Zielen wie Venedig, Barcelona oder Phuket zu Umweltschäden und steigenden Mieten für Einheimische. Deshalb sollten Urlauber auch Nebensaisonen oder weniger bekannte Regionen wählen. Ein bewusster Umgang mit Reisen bedeutet nicht Verzicht, sondern Qualität vor Quantität: lieber seltener, dafür länger und intensiver reisen. So schützt man sowohl die Umwelt als auch die eigene Erholung.", russian: "Путешествия расширяют кругозор и способствуют толерантности. Тот, кто знакомится с чужими культурами, языками и образами жизни, развивает понимание других перспектив. Устойчивое путешествие означает поддержку местной экономики, бережное отношение к ресурсам и уважение к природе. Вместо массового туризма рекомендуются длительные поездки или эко-лоджи. Путешествия на поезде выбрасывают меньше CO2, чем полёты, а велосипедные поездки — самые климатически нейтральные. К сожалению, чрезмерный туризм в популярных местах, таких как Венеция, Барселона или Пхукет, приводит к ущербу для окружающей среды и росту арендной платы для местных жителей. Поэтому туристам следует выбирать межсезонье или менее известные регионы. Осознанное отношение к путешествиям означает не отказ, а качество вместо количества: лучше реже, но дольше и интенсивнее. Так вы защищаете и окружающую среду, и собственный отдых." }
        ]
    };
